...
// If it was normal , always running backend server, we woould be using the following code
// const User = model("User", UserSchema);
// export default User;
// The route will be run only wehen it is called
...
export default User;
// As this connection will be callled evertime when we route to the page
// Thus, we will check before creating to prevent redundancy
